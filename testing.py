...
from validation import translate, clean_content, generate_content_with_retries
from process_images import optimize_image


parser = argparse.ArgumentParser()
parser.add_argument("--data_path", type=str, help="Path to the image", default="dataset/Clean_dataset")
parser.add_argument("--image", type=str, help="Path to the image", default="dataset/testing/dress.jpg")
...
output_path = f"dataset/testing/{name}_lowres.jpg"
optimize_image(args.image, output_path)
